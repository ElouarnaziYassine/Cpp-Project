...
public:
    ...
    void retranslateUi(QDialog *Finish)
    {
        ...
        label_8->setText(QCoreApplication::translate("Finish", "Food (MAD)", nullptr));
        label_7->setText(QCoreApplication::translate("Finish", "Tickets (MAD)", nullptr));
        ...
        label_13->setText(QCoreApplication::translate("Finish", "<html><head/><body><p><span style=\" font-size:16pt;\">Total (MAD)</span></p></body></html>", nullptr));
